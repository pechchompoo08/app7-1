...
export default function Formbootstrap() {
    ...
    if (Pn !== '' && !Pn.match(/^([0-9]{1,10})+$/)){
        ...
        alert('เบอร์โทรต้องเป็น 0-9  เท่านั้น')
     }
 }
    return (
         <div class="container">
            <form action="/action_page.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="PhoneNumber" placeholder="Enter PhoneNumber" name="PhoneNumber" ref={PhoneNumber} onBlur={onBlurPhoneNumber} />
                </div>
